...
<li <?php post_class( $classes ); ?>>
  ...
  <div class="ecc-grid-product" style="background:#FFF;">
    <div class="ecc-grid-product-image"> <a href="<?php the_permalink(); ?>">
      ...
      <div class="ecc-grid-product-new-label" style="display:<?php echo (has_term( 'new', 'product_tag'))? 'block': 'none' ?>"><img src="<?php get_template_directory_uri();?>/images/ecc-new-label.png/"></div>
      </a> </div>
    <div class="ecc-grid-product-info-wrapper">
      <div class="ecc-grid-product-info">
        ...
        <div class="ecc-grid-product-price price"><?php echo woocommerce_price($product->get_price());?></div>
        <?php
			/**
