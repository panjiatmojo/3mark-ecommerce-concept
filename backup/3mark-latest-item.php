<?php
      //	create query to show latest item
      	
      $wp_query = new WP_Query( array( 'post_type' => 'wpsc-product', 'posts_per_page' => 5, 'paged' => 1 ) );
...
<div class="latest-item">
  <h1 class="title"> <span><?php echo (get_option("3mark_word_latest_item")? get_option("3mark_word_latest_item"): "Latest Item") ?></span> </h1>
