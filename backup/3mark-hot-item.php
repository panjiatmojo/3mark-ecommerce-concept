<?php
      //	create query to show hot item
	  $category_name = 'hot-item';
      $wp_query = new WP_Query( array( 'post_type' => 'wpsc-product', 'posts_per_page' => 5, 'paged' => 1 , 'wpsc_product_category' => $category_name, 'orderby' => 'modified', 'order' => 'desc') );	
...
<div class="latest-item">
  <h1 class="title"> <span><?php echo (get_option("3mark_word_hot_item")? get_option("3mark_word_hot_item"): "Hot Item") ?></span> </h1>
  <div class="wpsc_default_product_list">
    ...
    <div class="default_product_display product_view_<?php echo wpsc_the_product_id(); ?> <?php //echo wpsc_category_class(); ?> group">
      ...
      <div class="imagecol" style="width:<?php echo $image_width; ?>px;" id="imagecol_<?php echo wpsc_the_product_id(); ?>">
        ...
        <div class="view-detail"><?php echo get_option('3mark_word_detail','Detail')?></div>
        </a>
        <?php else: ?>
